...
namespace guionlineticketing
{
    public partial class addevent : System.Web.UI.Page
    {
        ...
        protected void btnaddevent_Click(object sender, EventArgs e)
        {
            ...
            string query = string.Format("insert into eventtable (eventname,eventcategory,auditoriumid,image,eventdate,eventtime,noofseats)  values('{0}','{1}',{2},'{3}','{4}','{5}',{6})", txteventmane.Text, ddlcategory.SelectedItem.Text, ddllocation.SelectedItem.Value, "images/" + imageupload.FileName, date.ToString("mm/dd/yyyy"), txttime.Text,txtnoofseats.Text);
